...
public class Button implements Sprite {
    ...
    public Button(int x, int y, int widht, int heigth, Font f, Color c, Color textC, String text, Runnable press, Button activeButton) {
        sx = (double)x / 800;
        sy = (double)y / 600;
    ...
    public Button(int x, int y, int widht, int heigth, Font f, Color c, Color textC, String text) {
        this(x, y, widht, heigth, f, c, textC, text, null, null);
    }
